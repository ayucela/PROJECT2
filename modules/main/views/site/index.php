                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    ...
                                    <div class="datepicker-wrap">
                                       <input type="text" name="MainSearchForm[date_from]"  id="mainsearchform-date_from" class="input-text full-width form-control" placeholder="mm/dd/yy" readonly/>
                                    </div>
<!--                                    <div class="help-block">--><?//= $searchForm->errors['date_from'] ? $searchForm->errors['date_from'][0] : ''?><!--</div>-->
                                ...
                                <div class="col-xs-6">
                                    ...
                                    <div class="datepicker-wrap">
                                       <input type="text" name="MainSearchForm[date_to]" id="mainsearchform-date_to" class="input-text full-width form-control" placeholder="mm/dd/yy" readonly/>
                                    </div>
